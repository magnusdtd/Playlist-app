...
def write_videos_to_txt(videos, file):
	total= len(videos)
	file.write(str(total)+ "\n") #Do có dòng này nên đầu file luôn là số video
...
def read_playlist():
	...
	playlist_description = input("Enter playlist_description: ") +"\n"
...
def update_playlist(playlist):
	...
	if choice== 1:
		...
		return playlist
	if choice== 2:
		new_playlist_desciption= input("Enter new description for playlist ")+"\n"
		playlist.description= new_playlist_desciption
		print("Updated Successfully !")
		return playlist
	if choice== 3:
		new_playlist_rating= str(select_in_range("Enter new rating for playlist ",1,5)) +"\n"
